...
const{storeUser, storeConteudo, getDadosConteudo, storeID, getDados, getDadosUser, getConteudo, updateUser, getDataUser, getRanking} = require('../controller/userController')
...
*                  type: object
*/
router.get('/user/data/:id', getConteudo);
